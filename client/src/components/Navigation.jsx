 ...
 * - Module Tab Selectors (POS, PRM, AI Doctor, Voice Agent, WhatsApp, Reports, etc.)
  ...
  return (
    <header className="sticky top-0 z-50 glass-panel border-b border-white/10 bg-slate-950/80 backdrop-blur-md px-4 py-2.5 mb-6">
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <nav className="flex items-center space-x-1 overflow-x-auto py-1 max-w-2xl no-scrollbar">
          {navItems.map((item) => {
        ...
        <div className="flex items-center space-x-3">
          ...
          {/* Offline / Online Status & Outbox Sync Button */}
